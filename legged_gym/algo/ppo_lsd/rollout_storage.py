...
class RolloutStorage:
    ...
    def __init__(self, num_envs, num_transitions_per_env, obs_shape, critic_obs_shape, privileged_obs_shape, obs_history_shape, actions_shape, device="cpu"):
        ...
        self.next_critic_obs = torch.zeros(num_transitions_per_env, num_envs, *critic_obs_shape, device=self.device)
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        next_critic_obs = self.next_critic_obs.flatten(0, 1)
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                next_critic_obs_batch = next_critic_obs[batch_idx]
                ...
                yield (obs_batch, critic_observations_batch, privileged_observations_batch, obs_history_batch, next_obs_batch, next_critic_obs_batch,
                       actions_batch, target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch,
                       old_mu_batch, old_sigma_batch, (None, None, ), None, dones_batch)
    ...
    def reccurent_mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        for ep in range(num_epochs):
            ...
            for i in range(num_mini_batches):
                ...
                next_obs_batch = self.next_obs[:, start:stop]
                next_critic_obs_batch = self.next_critic_obs[:, start:stop]
                ...
                yield (obs_batch, critic_obs_batch, privileged_obs_batch, obs_history_batch, next_obs_batch, next_critic_obs_batch,
                        actions_batch, values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch,
                       old_mu_batch, old_sigma_batch, (hid_a_batch, hid_c_batch,), masks_batch, dones_batch)
