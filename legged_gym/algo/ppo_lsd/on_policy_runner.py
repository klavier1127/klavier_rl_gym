...
class LSDOnPolicyRunner:
        ...
        for it in range(self.current_learning_iteration, tot_iter):
            ...
            with torch.inference_mode():
                for i in range(self.num_steps_per_env):
                    ...
                    self.alg.process_env_step(rewards, dones, obs, critic_obs, infos)
            ...
            mean_value_loss, mean_surrogate_loss, mean_predict_loss = self.alg.update()
    ...
    def log(self, locs, width=80, pad=35):
        ...
        self.writer.add_scalar('Loss/predict', locs['mean_predict_loss'], locs['it'])
