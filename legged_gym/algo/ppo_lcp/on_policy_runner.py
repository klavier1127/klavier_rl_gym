...
class LCPOnPolicyRunner:
    ...
    def learn(self, num_learning_iterations, init_at_random_ep_len=False):
        ...
        for it in range(self.current_learning_iteration, tot_iter):
            ...
            mean_value_loss, mean_surrogate_loss, mean_adaptation_module_loss, mean_grad_penalty_loss = self.alg.update()
            stop = time.time()
    ...
    def log(self, locs, width=80, pad=35):
        ...
        self.writer.add_scalar('Loss/Grad_penalty', locs['mean_grad_penalty_loss'], locs['it'])
