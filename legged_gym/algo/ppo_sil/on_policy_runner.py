...
from legged_gym.algo.ppo_sil.amp_discriminator import AMPDiscriminator
from legged_gym.algo.ppo_sil.datasets.motion_loader_12dof_humanoid import AMPLoader
from legged_gym.algo.utils.utils import Normalizer


class SILOnPolicyRunner:
        ...
        for it in range(self.current_learning_iteration, tot_iter):
            ...
            with torch.inference_mode():
                for i in range(self.num_steps_per_env):
                    actions = self.alg.act(obs, critic_obs, obs_history, amp_obs)
                    ...
                    rewards += 0.2 * self.alg.discriminator.predict_amp_reward(
                        last_amp_obs, amp_obs, rewards, normalizer=self.alg.amp_normalizer)[0]
