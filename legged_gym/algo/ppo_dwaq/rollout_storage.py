...
class RolloutStorage:
    ...
    def __init__(self, num_envs, num_transitions_per_env, obs_shape, critic_obs_shape, privileged_obs_shape, obs_history_shape, single_obs_shape, actions_shape, device="cpu"):
        self.device = device
        self.obs_shape = obs_shape
        self.critic_obs_shape = critic_obs_shape
        self.privileged_obs_shape = privileged_obs_shape
        self.obs_history_shape = obs_history_shape
        self.next_obs_shape = single_obs_shape
        ...
        self.next_obs = torch.zeros(num_transitions_per_env, num_envs, *single_obs_shape, device=self.device)
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                yield (obs_batch, critic_observations_batch, privileged_observations_batch, obs_history_batch, next_obs_batch,
                       actions_batch, target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch,
                       old_mu_batch, old_sigma_batch, dones_batch)
