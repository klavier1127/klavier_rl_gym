...
class PPO:
    ...
    def __init__(self,
        ...
        self.adaptation_module_optimizer = optim.Adam(self.actor_critic.adaptation_module.parameters(), lr=learning_rate)
    ...
    def act(self, obs, critic_obs, privileged_obs, obs_history):
        ...
        self.transition.actions = self.actor_critic.act_student(obs, obs_history).detach()
    ...
    def update(self):
        ...
        for (obs_batch, critic_obs_batch, privileged_obs_batch, obs_history_batch, actions_batch,
             target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch,
                ...
                self.actor_critic.act(obs_batch, privileged_obs_batch)
                ...
                adaptation_loss = nn.MSELoss()(adaptation_pred, adaptation_target)
