...
class AMPDiscriminator(nn.Module):
    def __init__(self, input_dim, amp_reward_coef, device, hidden_layer_sizes=[512, 256]):
    ...
    def compute_grad_pen(self, expert_state, expert_next_state, lambda_=10):
        ...
        grad = autograd.grad(outputs=disc, inputs=expert_data, grad_outputs=ones, create_graph=True, retain_graph=True, only_inputs=True)[0]
