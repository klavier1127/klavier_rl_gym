...
from legged_gym.algo.ppo_amp.replay_buffer import ReplayBuffer
...
class PPO:
    ...
    def __init__(self,
        ...
        self.amp_optimizer = optim.Adam(params2, lr=self.learning_rate)
    ...
    def update(self):
        ...
        for sample, sample_amp_policy, sample_amp_expert in zip(generator, amp_policy_generator, amp_expert_generator):
                obs_batch, critic_obs_batch, obs_history_batch, actions_batch, target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch, \
                old_mu_batch, old_sigma_batch, hid_states_batch, masks_batch = sample

                self.actor_critic.act(obs_batch.detach(), critic_obs_batch, obs_history_batch)
