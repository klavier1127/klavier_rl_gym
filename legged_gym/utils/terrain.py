...
class HumanoidTerrain(Terrain):
    ...
    def make_terrain(self, choice, difficulty):
        ...
        if choice < self.proportions[0]:
            ...
            terrain_utils.random_uniform_terrain(terrain, min_height=-r_height, max_height=r_height, step=0.005,
                                                 downsampled_scale=0.2)
        elif choice < self.proportions[3]:
            ...
            terrain_utils.pyramid_stairs_terrain(terrain, step_width=0.4, step_height=discrete_obstacles_height,
                                                 platform_size=1.)
        elif choice < self.proportions[6]:
            terrain_utils.pyramid_stairs_terrain(terrain, step_width=0.4, step_height=-discrete_obstacles_height,
                                                 platform_size=1.)
