...
from legged_gym.envs.go2_amp.go2_amp_config import go2AMPCfg
...
def run_mujoco(policy, cfg):
    ...
    default_pos = [0.0, 0.8, -1.5,   -0.0, 0.8, -1.5,    0.0, 1.0, -1.5,    -0.0, 1.0, -1.5]
...
if __name__ == '__main__':
    ...
    model_path = "../logs/go2_amp/exported/policies/policy_mlp.pt"
