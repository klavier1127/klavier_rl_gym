...
def run_mujoco(policy, cfg):
    ...
    default_pos = [0, 0, -0.1, 0.3, -0.2, 0, 0, -0.1, 0.3, -0.2]
...
if __name__ == '__main__':
    ...
    class Sim2simCfg(h1Cfg):
        ...
        class sim_config:
            mujoco_model_path = f'{LEGGED_GYM_ROOT_DIR}/resources/robots/h1/scene.xml'
            sim_duration = 60.0
            dt = 0.001
            decimation = 20
    ...
    model_path = "../logs/h1/exported/policies/policy_pia.pt"
